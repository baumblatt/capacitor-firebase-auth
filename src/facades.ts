 ...
 */
export const cfaSignInGoogle = (auth: Auth): Observable<User> => {
  return new Observable((observer) => {
    ...
    // native sign in
    plugin
      .signIn<GoogleSignInResult>({ providerId }, auth)
 ...
 */
export const cfaSignInTwitter = (auth: Auth): Observable<User> => {
  return new Observable((observer) => {
    // get the provider id
    ...
    // native sign in
    plugin
      .signIn<TwitterSignInResult>({ providerId }, auth)
 ...
 */
export const cfaSignInFacebook = (auth: Auth): Observable<User> => {
  return new Observable((observer) => {
    // get the provider id
    ...
    // native sign in
    plugin
      .signIn<FacebookSignInResult>({ providerId }, auth)
 ...
 */
export const cfaSignInApple = (auth: Auth): Observable<User> => {
  return new Observable((observer) => {
    // native sign in
    plugin
      .signIn<AppleSignInResult>({ providerId: cfaSignInAppleProvider }, auth)
 ...
 */
export const cfaSignOut = (auth: Auth): Observable<void> => {
  return new Observable((observer) => {
    plugin.signOut({}, auth).then(() => {
      // web sign out
      signOut(auth)
        .then(() => {
          observer.next();
