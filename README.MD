...
Issue 38#: interoperability with [Stencil](https://getstencil.com/), thanks to [Justin Rich](https://github.com/socalrunner).
...
> The firebase import was changed using `esModuleInterop`, that was a [Stencil](https://getstencil.com/) requirements, please see issue [#38](https://github.com/baumblatt/capacitor-firebase-auth/issues/38).
