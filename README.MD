...
Important: the version 2.2.0 is tagged as `future`, you can track this on issue [#84](https://github.com/baumblatt/capacitor-firebase-auth/issues/84).
