...
#### from 2.0.x to 2.2.x
> You need to use version 2.2.0 of the Capacitor Framework duet braking changes.
...
1. There isn't any specific configuration on Android and iOs native projects duet the use of firebase OAuthProvider.
